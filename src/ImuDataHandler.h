 ...
 * @details Plik ten zawiera definicję klasy `ImuDataHandler`, która jest kluczowym komponentem
 * interfejsu użytkownika dedykowanym do obsługi, przetwarzania i wizualizacji danych
 * pochodzących z jednostki IMU (akcelerometr, żyroskop, magnetometr).
 * Klasa ta odpowiada za:
 * - Odbieranie i aktualizowanie danych z sensorów.
 * - Prezentację danych numerycznych w czasie rzeczywistym za pomocą pasków postępu.
 * - Wizualizację danych historycznych w postaci wykresów czasowych.
 * - Renderowanie orientacji przestrzennej urządzenia w środowisku 3D.
 * - Wyświetlanie wskazań kompasu w widoku 2D.
 * - Umożliwienie użytkownikowi przełączania się między widokiem danych bieżących
 * a widokiem danych historycznych (wykresów).
 * - Obsługę internacjonalizacji interfejsu użytkownika, pozwalając na dynamiczną
 * zmianę języka wyświetlanych etykiet i komunikatów.
 *
...
public:
     ...
     * @param samples [in] Liczba próbek do wyświetlenia. Wartość minimalna to 10.
     */
     ...
     * @param yaw [in] Kąt odchylenia (obrót wokół osi Z globalnego układu współrzędnych) w stopniach.
     * @param pitch [in] Kąt pochylenia (obrót wokół osi X globalnego układu współrzędnych) w stopniach.
     * @param roll [in] Kąt przechylenia (obrót wokół osi Y globalnego układu współrzędnych) w stopniach.
     */
     ...
     * @param heading [in] Kierunek w stopniach, gdzie 0 stopni oznacza Północ.
     */
...
private:
     ...
     * @param rootEntity [in] Wskaźnik na główną encję sceny.
     */
